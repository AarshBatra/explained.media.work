...
#   geom_hline(mapping = aes(yintercept = 1.25), color = "#0C475F", linetype = "solid") +
  ...
  geom_text(aes(label = llpp_who_2021, y = (llpp_who_2021 - 0.085)), hjust = 0.1, color = "#663300", size = 10, family = f1, 
            fontface = "bold") +
 ...
 # scale_x_discrete(limits = cause_of_death_ordered[seq(1, length(cause_of_death_ordered), by = 2)]) +
  scale_fill_manual(values = c("0 - < 0.1" = "#FFFFFF", 
   ...
   theme(legend.position = "none", 
        ...
        axis.title.x = element_text(color = "white", hjust = 0.99, size = 31, family = f1, margin = margin(b = 0.5, t = 0.2, unit = "cm")),
      ...
      ggtext::geom_textbox(aes(x = 4.9,
                         ...
                         color = "white") 
# save plot
ggsave(paste0(here(), "/output/pm2.5_compared_to_other_threats.png"), pm2.5_comparison_oth_threats_plt, width = 16.5, height = 9, dpi = 320, scale = 2)
