...
pm2.5_comparison_oth_threats_plt <- pm2.5_comparison_oth_threats_data %>%
  mutate(llpp_who_2021 = round(llpp_who_2021, 1), 
         cause_of_death = ifelse(cause_of_death == "PM2.5 relative to WHO guideline", "PM₂.₅ relative to WHO guidline", cause_of_death)) %>%
...
#   geom_hline(mapping = aes(yintercept = 1.25), color = "#0C475F", linetype = "solid") +
  ...
  geom_text(aes(label = llpp_who_2021, y = (llpp_who_2021 - 0.085)), hjust = 0, color = "#663300", size = 10, family = f1) +
 ...
 # scale_x_discrete(limits = cause_of_death_ordered[seq(1, length(cause_of_death_ordered), by = 2)]) +
  scale_fill_manual(values = c("0 - < 0.1" = "#FFFFFF", 
   ...
   theme(legend.position = "none", 
        ...
        plot.background = element_rect(colour = "#022531",
                                       fill = "#022531"), 
        plot.caption = element_text(size = 17, hjust = 0.5, color = "white"), 
        ...
        axis.text.y = element_text(color = c("PM2.5 relative to WHO guideline" = "#FFFFFF", 
                                             "Tobacco" = "#FFE6B3", 
                                             ...
                                             "Nutritional deficiencies" = "#FF9600"), hjust = 0.5, size = 30, family = f1),
        axis.text.x = element_text(color = "white", hjust = 0.5, size = 30, family = f1),
        axis.title.x = element_text(color = "white", hjust = 1, size = 31, family = f1, margin = margin(b = 0.5, t = 0.2, unit = "cm")),
        axis.line = element_line(color = "#0C475F")) +
      ggtext::geom_textbox(aes(x = 5.1,
                             y = 1.1),
                         label = "Selected **<span style=\"color:#CC6633\">major global threats</span>** to Life Expectancy",
                         ...
                         color = "white") 
# save plot
ggsave(paste0(here(), "/output/pm2.5_compared_to_other_threats.png"), pm2.5_comparison_oth_threats_plt, width = 9.5, height = 5, dpi = 320)
