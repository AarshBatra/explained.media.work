...
# read in
color_2020 <- read_csv(paste0(here(), "/data-raw/master.dataset/archive/color_2020.csv"))
color_2019 <- read_csv(paste0(here(), "/data-raw/master.dataset/archive/color_2019.csv"))
color_2016 <- read_csv(paste0(here(), "/data-raw/master.dataset/archive/color_2016.csv"))
