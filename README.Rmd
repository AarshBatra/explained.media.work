...
# removing extremely tiny polygons to focus on the main map
...
tb_annotation <- tibble(
  label_x = c(-142.07, 64.83, -9, 124.05, -87.72, -32.66),
  label_y = c(18.11, 6, -0.54, -49.09, -20.34, 40.04),
...
aqli_global_gadm2_map <- aqli_global_gadm2_data %>%
 ...
 annotate("segment", x = -118.25, xend = -134, y = 34.09, yend = 23.2, arrow = arrow(type = "closed", length = unit(0.2, "inches")), colour = "white", curvature  = 1.8) + # US
 annotate("segment", x = 77.14, xend = 65.09, y = 28.68, yend = 11.82, arrow = arrow(type = "closed", length = unit(0.2, "inches")), colour = "white", curvature  = -0.5) +
 ...
 annotate("segment", x = 144.97, xend = 131.18, y = -37.97, yend = -41.01, arrow = arrow(type = "closed", length = unit(0.2, "inches")), colour = "white", curvature  = -0.5) +
 annotate("segment", x = -77.03, xend = -82.74, y = -12.02, yend = -16.39, arrow = arrow(type = "closed", length = unit(0.2, "inches")), colour = "white", curvature  = 1.8) +
annotate("segment", x = 21.03, xend = -19.7, y = 52.24, yend = 40.51, arrow = arrow(type = "closed", length = unit(0.2, "inches")), colour = "white", curvature  = 0.5) +
      coord_sf(default_crs = sf::st_crs(4326)) +
  ggthemes::theme_map() +
labs(title = "How much longer can you live if you breathed clean air?",
     subtitle = expression("Years gained if pollution is reduced to meet the WHO" ~ PM[2.5] ~ "guideline"),
caption = "Source · Air Quality Life Index, Annual Report 2023") + 
  theme(legend.position = c(0.55, 0.99), 
        ...
        plot.title = element_text(size = 35, family = "Segoe UI", face = "bold", color = "white", hjust = 0.05, 
                                  margin = margin(b = 0.5, unit = "cm")),
        plot.subtitle = element_text(size = 22, family = "Segoe UI", face = "italic", color = "white", hjust = 0.05),
...
ggsave("map.png", aqli_global_gadm2_map, width = 17, height = 9, dpi = 320, scale = 2)
